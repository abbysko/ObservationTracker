...
- Do not introduce unnecessary frameworks; prefer lightweight libraries when they clearly improve maintainability.
- Preserve the architecture and repository boundaries.
- Ask before changing requirements.
- Prefer incremental improvements and avoid premature optimization.
